...
const models: Model[] = [
  ...
  { name: 'gpt-5.5', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.4', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.2', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5.1', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5-2025-08-07', inputTypes: InputTypes.commonVision },
  { name: 'gpt-5-mini', inputTypes: InputTypes.commonVision },
  ...
  { name: 'claude-sonnet-4-6', inputTypes: InputTypes.claudePdf },
  ...
  { name: 'claude-opus-4-7', inputTypes: InputTypes.claudePdf },
  { name: 'claude-opus-4-6', inputTypes: InputTypes.claudePdf },
  ...
  { name: 'gemini-3.1-pro-preview', inputTypes: InputTypes.gemini2 },
  { name: 'gemini-3-pro-preview', inputTypes: InputTypes.gemini2 },
  ...
  { name: 'gemini-3-flash-preview', inputTypes: InputTypes.gemini2 },
  ...
  { name: 'qwen3-vl-235b-a22b-thinking', inputTypes: InputTypes.commonVision },
  { name: 'qwen3-vl-235b-a22b-instruct', inputTypes: InputTypes.commonVision },
